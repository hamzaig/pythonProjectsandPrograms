...
g.h.show=function(){this.u=new g.$m(this.lI,null,this);this.u.start();if(!this.H){this.C=new g.RP(this.player,this);g.C(this,this.C);g.zK(this.player,this.C.element,4);this.C.B=.6;this.R=new g.SO(this.player);g.C(this,this.R);this.A=new g.S({D:"div",I:"ytp-miniplayer-scrim"});g.C(this,this.A);this.A.ba(this.element);this.L(this.A.element,"click",this.eB);var a=new g.S({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],N:{"aria-label":"Close"},K:[g.pL()]});g.C(this,a);a.ba(this.A.element);
this.L(a.element,"click",this.xz);a=new P5(this.player,this);g.C(this,a);a.ba(this.A.element);this.B=new g.S({D:"div",I:"ytp-miniplayer-controls"});g.C(this,this.B);this.B.ba(this.A.element);this.L(this.B.element,"click",this.eB);var b=new g.S({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,b);b.ba(this.B.element);a=new g.S({D:"div",I:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ba(this.B.element);var c=new g.S({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,c);c.ba(this.B.element);
...
"ytp-button"],N:{"aria-label":"Close"},K:[g.pL()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.xz);a=new g.S({D:"button",Y:["ytp-miniplayer-replay-button","ytp-button"],N:{"aria-label":"Close"},K:[g.DL()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.IM);this.L(this.player,"presentingplayerstatechange",this.nI);this.L(this.player,"appresize",this.Bt);this.L(this.player,"fullscreentoggled",this.Bt);this.Bt();this.H=!0}0!=this.player.getPlayerState()&&g.S.prototype.show.call(this);
